    ...
    public function setAccessToken($google_token = null)
    {
        try {
            ...
            if (!is_null($google_token))
                $this->googleClient->setAccessToken($google_token);

            if (!is_null($google_token) && $this->googleClient->isAccessTokenExpired()) {
                $refreshed_token = $this->googleClient->getRefreshToken();
                $this->googleClient->fetchAccessTokenWithRefreshToken($refreshed_token);
